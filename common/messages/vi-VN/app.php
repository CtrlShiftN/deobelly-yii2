...
return [
    ...
    'Username or password incorrect.'=>'Tên đăng nhập hoặc mật khẩu không chính xác.',
    'Email can not be blank.'=>'Email không đươc để trống.',
    'This email address is already in use.'=>'Địa chỉ email này đã được sử dụng.',
    'Comfirm-password can not be blank.'=>'Nhập lại mật khẩu không đươc để trống.',
    ...
    'Thank you for registration. Please check your inbox for verification email.'=>'Cảm ơn bạn đã đăng ký. Vui lòng kiểm tra hộp thư đến của bạn để biết email xác minh.',
