...
",
            ...
            'category_id' => '3-1',
            'product_category' => '1@0,2@0,3@0,7@0',
            'trademark_id' => '1',
            'admin_id' => 1,
        ],
        [
...
",
    ...
    protected static $productCategoryInfoArr = [
        ...
        [
            'name' => 'Áo thun',
            'slug' => 'ao-thun',
            'code' => '3-1,1@2,2@2,3@2,7@2',
            'admin_id' => 1,
        ],
        [
            'name' => 'Áo Vest',
            'slug' => 'ao-vest',
            'code' => '3-2,1@3,2@3,3@3,7@3',
            'admin_id' => 1,
        ],
        [
            'name' => 'Quần âu',
            'slug' => 'quan-au',
            'code' => '4-1,1@4,2@4,4@1,7@4',
            'admin_id' => 1,
        ],
        [
            'name' => 'Giày thể thao',
            'slug' => 'giay-the-thao',
            'code' => '5-1,1@5,2@5,5@1,7@5',
            'admin_id' => 1,
        ],
        [
            'name' => 'Dây lưng',
            'slug' => 'day-lung',
            'code' => '6-1,1@6,2@6,6@1,7@6',
            'admin_id' => 1,
        ],
        [
            'name' => 'Váy',
            'slug' => 'vay',
            'code' => '4-2,2@7,4@2,7@7',
            'admin_id' => 1,
        ],
//        [
...
//        ],
    ...
    protected static $metaInfoArr = [
        ...
        [
            'key' => 'product_max_category_type_trousers',
            'value' => '4@2',
        ],
        [
            'key' => 'product_max_category_type_shoes',
            'value' => '5@1',
        ],
        [
