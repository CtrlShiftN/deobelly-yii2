...
class m210827_022555_create_product_table extends Migration
{
    ...
    public function safeUp()
    {
        $this->createTable('{{%product}}', [
            ...
            'is_luxury' => $this->smallInteger(2)->defaultValue(0)->comment('0 for basic, 1 for luxury'),
            'related_product' => $this->string(),
            'gender' => $this->smallInteger(2)->defaultValue(0)->comment('0 for both, 1 for male, 2 for female'),
            ...
            'amount' => $this->integer()->defaultValue(0)->notNull(),
