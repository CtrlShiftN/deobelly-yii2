...
$this->registerJsFile('/js/collection.js');
?>
    ...
    <div class="weekly-collection mt-3">
        ...
        <div class="row mx-0 justify-content-center px-0 w-100">
            <div id="recipeCarousel" class="mixAndMatchCarousel carousel slide px-0 w-100" data-bs-ride="carousel">
                ...
                <button class="carousel-control-prev" type="button" data-bs-target="#recipeCarousel" id="btnNextRecipeCarousel"
                        data-bs-slide="prev">
                    <i class="fas fa-chevron-left fa-3x text-dark"></i>
                </button>
                <button class="carousel-control-next" type="button" data-bs-target="#recipeCarousel" id="btnPrevRecipeCarousel"
                        data-bs-slide="next">
