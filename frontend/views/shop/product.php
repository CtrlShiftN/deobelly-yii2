                ...
                <?php foreach ($productType as $key => $value): ?>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="offcanvas-flush-heading-<?= $idEncrypted ?>">
                            ...
                            <input type='hidden' class="type w-100" value="<?= $value['id'] ?>">
                            <input type='hidden' class="type-name w-100" value="<?= $value['name'] ?>">
                        </h2>
...
<script>
    ...
    var category, type, typeName, cursor, sort, productCategory;
...
//    <?php //endif; ?>
    ...
    $('.accordion-button').click(function () {
        ...
        if (!$(this).hasClass('collapsed')) {
            type = $(this).parent().children('.type').val();
            typeName = $(this).parent().children('.type-name').val();
        } else {
            type = typeName = null;
        }
        requestData();
