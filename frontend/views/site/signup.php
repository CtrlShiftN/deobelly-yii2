            ...
            <div class="mx-md-4 my-md-3 py-md-4 px-3 w-100">
                ...
                <div class="mt-2">
                    <?= $form->field($model, 'name')
                        ->textInput(['autofocus' => true, 'class' => 'border-0 border-bottom rounded-0 form-control', 'placeholder' => Yii::t('app', 'Enter first and last name')])->label(false)
                    ?>
                </div>
                <div class="mt-2">
                    <?= $form->field($model, 'tel')
                        ->textInput(['type' => 'number', 'class' => 'border-0 border-bottom rounded-0 form-control', 'placeholder' => Yii::t('app', 'Enter phone number')])->label(false) ?>
                </div>
                <div class="mt-2">
