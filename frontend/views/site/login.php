        ...
        <div class="col-12 col-lg-6 col-xl-5 py-sm-0 py-4 d-flex align-items-center bg-input-field">
            <div class="mx-md-4 my-md-3 py-md-4 p-3 w-100">
                ...
                <div class="row mx-0 my-3 p-0">
                    <div class="col-12 col-sm-6 m-0 p-1">
                        <a class="col-12 btn btn-primary py-2" hidden><i class="fab fa-facebook-f"></i> Facebook</a>
                    </div>
                    <div class="col-12 col-sm-6 m-0 p-1">
                        <a class="col-12 btn btn-danger py-2" href="/access/auth?authclient=google"><i class="fab fa-google"></i> Google</a>
                    </div>
                </div>
                <div class="my-3">
