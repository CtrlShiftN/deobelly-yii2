    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
                ...
                <a href="<?= \yii\helpers\Url::toRoute('tailor-made-order/') ?>" class="small-box-footer" target="_blank"><?= Yii::t('app', 'More info') ?> <i class="fas fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
                ...
                <a href="<?= \yii\helpers\Url::toRoute('mix-and-match/') ?>" class="small-box-footer" target="_blank"><?= Yii::t('app', 'More info') ?> <i class="fas fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3 col-6">
                            <div class="description-block">
                                <span class="description-percentage text-success"><i
                                            class="fas fa-caret-up"></i> 18%</span>
