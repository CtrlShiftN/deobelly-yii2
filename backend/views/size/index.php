    ...
    <div class="pt-3">
        ...
        $gridColumns = [
            ...
            [
                ...
                'width' => '150px',
                'value' => function ($model, $key, $index, $widget) {
                    return Html::a('Xóa', Url::toRoute(['size/delete', 'id' => \common\components\encrypt\CryptHelper::encryptString($key)]), ['class' => 'btn btn-danger', 'data' => [
                        'method' => 'post',
...
//            'containerOptions' => ['style' => 'overflow: auto'], // only set when $responsive = false
            ...
            'toolbar' => [
                [
                    'content' => Html::button('<i class="fas fa-plus"></i> ' . Yii::t('app', 'Add New Size'), [
                        'value' => Url::toRoute('size/create'),
                        'class' => 'btn btn-success',
                        'id' => 'modalSizeButton',
                        'data-bs-toggle' => 'modal',
                        'data-bs-target' => '#modalSize'
                    ]),
        ...
        <script>
            $(document).ready(function () {
                $('.modal-category-content').load($('#modalSizeButton').attr('value'));
            });
        </script>
    </div>
</div>
