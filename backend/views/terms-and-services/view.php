...
/* @var $model backend\models\TermsAndServices */
...
//        'buttons1' => '{delete}',
        ...
        'deleteOptions' => [
            'url' => \yii\helpers\Url::toRoute(['terms-and-services/delete', 'id' => \common\components\encrypt\CryptHelper::encryptString($model->id)]),
