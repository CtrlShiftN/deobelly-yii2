    ...
    <div class="row pb-3">
        ...
        <div class="col-12 col-sm-6 col-md-5 col-lg-6">
            <?= $form->field($model, 'types')->widget(Select2::classname(), [
                'data' => \common\components\helpers\SystemArrayHelper::removeElementAt(ArrayHelper::map($types, 'id', 'name'), [\common\components\SystemConstant::PRODUCT_TYPE_NEW,\common\components\SystemConstant::PRODUCT_TYPE_TAILOR_MADE,\common\components\SystemConstant::PRODUCT_TYPE_MIX_AND_MATCH]),
